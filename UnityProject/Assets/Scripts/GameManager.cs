...
public class GameManager : MonoBehaviour
{
    ...
    [SerializeField]
    [Tooltip("Spawn location of pokemon, in world space.")]
    private Vector3 pokemonSpawnLocation = Vector3.zero;
...
if (pokePrefab == null)
{
Debug.Log("pokePrefab null");
}
if (pokeData == null)
{
Debug.Log("pokeData null");
}
            return null;
        }
    }
    ...
    void Update()
    {
        if (Input.GetButtonDown("DebugAction"))
        {
            ...
            if (!playingPokemon)
            {
                ...
                Pokemon newPoke = InstantiatePokemon(newProfile, true, pokemonSpawnLocation + 2.0f * Vector3.up);
